...
import { defaultDateFormat, LIMIT, ROUTES } from '../../common/constants';
  ...
  const onFinish = async (name, { values }) => {
    if (name === 'detailsForm') {
      const updatedValues = {
        ...
        releaseDate: values?.releaseDate ? moment(values?.releaseDate) : null,
              ...
              <Row gutter={[16, 16]}>
                ...
                <Col xs={24} lg={12} xl={8}>
                  <Form.Item
                    ...
                    rules={[
                      { required, message: 'Please enter original language!' },
                    ]}
                  >
                    <Select
                      showSearch
                ...
                <Col xs={24} lg={12} xl={8}>
                  <Form.Item name="adult" label="Rated" valuePropName="checked">
